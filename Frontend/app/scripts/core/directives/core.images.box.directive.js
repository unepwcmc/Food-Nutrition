define(['angularAMD','core/directives/core.image.popup.directive' ], function (angularAMD) {

    'use strict';

    angularAMD.directive('imagesBox', ['$timeout', '$rootScope', 'toastr','BaseController','$window',
        function ( $timeout, $rootScope, toastr, BaseController , $window) {
